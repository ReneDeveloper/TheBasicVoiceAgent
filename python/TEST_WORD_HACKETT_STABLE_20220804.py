...
def main__WORD():
    ...
    doc_template.add_paragraph('PRIMER ITEM', style='List Number')
    doc_template.add_paragraph('SEGUNDO ITEM', style='List Number')
    doc_template.add_paragraph('TERCER ITEM', style='List Number')
    doc_template.add_paragraph('CUARTO ITEM', style='List Number')
    
    doc_NAME = f'SALIDA_{vdoc_out}.docx'
    doc_template.save(doc_NAME)
    print (F"ARCHIVO GENERADO:doc_NAME:{doc_NAME}")
